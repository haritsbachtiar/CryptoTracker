...
import com.plcoding.cryptotracker.crypto.presentation.model.toDisplayedNumber
    ...
    if (state.isLoading) {
        ...
        Column(
            ...
            FlowRow(
                ...
                InfoCard(
                    title = stringResource(id = R.string.marcket_cap),
                ...
                val absoluteChangeFormatted =
                    (coin.priceUsd.value * (coin.changePercent24Hr.value / 100)).toDisplayedNumber()
                val isPositive = coin.changePercent24Hr.value > 0.0
                val vectorResourceId = if (isPositive) {
                    R.drawable.trending
                } else {
                ...
                InfoCard(
                    ...
                    icon = ImageVector.vectorResource(id = vectorResourceId),
